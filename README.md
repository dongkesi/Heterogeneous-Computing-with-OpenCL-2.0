...
* 共享虚拟内存\(_Shared virtual memory_\)可增强编程的灵活性，从而能大幅度减少在数据转换上所消耗的资源和精力 
* 动态并行\(_Dynamic parallelism_\)将减少处理器上的负载，并避免瓶颈出现
...
* 使用最新OpenCL 2.0标准的特性，包括**内存处理、动态并行和图像特性**
...
* github 翻译地址：[https://github.com/xiaoweiChen/Heterogeneous-Computing-with-OpenCL-2.0](https://github.com/xiaoweiChen/Heterogeneous-Computing-with-OpenCL-2.0)
* gitbook 在线阅读：[https://www.gitbook.com/book/chenxiaowei/heterogeneous-computing-with-opencl2-0](https://www.gitbook.com/book/chenxiaowei/heterogeneous-computing-with-opencl2-0)
